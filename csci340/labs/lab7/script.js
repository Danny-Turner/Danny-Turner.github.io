...
//      setDateListener();
  ...
  function populateSetDropDown(sets) {
    ...
    $("selectSet>option:eq(1)").prop('selected', true);
  }
  ...
  function setDateListener() {
    $("#pickDate").on('change', function(){
      ...
      console.log("https://api.nasa.gov/planetary/apod?api_key=tz5Behp5ZLCd6jUVH5m1rbfEmT4AN1g4LHlZnX6G & date="+selectedDate);
      $.ajax({dataType: "json",
